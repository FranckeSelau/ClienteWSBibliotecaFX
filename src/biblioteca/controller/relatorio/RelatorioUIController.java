...
public class RelatorioUIController implements Initializable {
    ...
    @FXML
    private Button MenuItemRelatorioClientRetiradas;
    @FXML
    private Button MenuItemRelatorioRetiradasAtrasos;
    @FXML
    ...
    public void HandleMenuItemDisponivel(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        Parent root = FXMLLoader.load(Biblioteca.class.getResource("/biblioteca/view/relatorio/AnchorPaneLivrosDisp.fxml"));
        AnchorPaneRelatorio.getChildren().setAll(root);
    }

    public void HandleMenuItemRetiradasLivro(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        Parent root = FXMLLoader.load(Biblioteca.class.getResource("/biblioteca/view/relatorio/AnchorPaneLivrosRet.fxml"));
        AnchorPaneRelatorio.getChildren().setAll(root);
    }

    public void HandleMenuItemRetiradasCliente(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        Parent root = FXMLLoader.load(Biblioteca.class.getResource("/biblioteca/view/relatorio/AnchorPaneClientesRetiram.fxml"));
        AnchorPaneRelatorio.getChildren().setAll(root);
    }

    public void HandleMenuItemAtrasos(ActionEvent event) throws IOException {
        Stage stage = new Stage();
        Parent root = FXMLLoader.load(Biblioteca.class.getResource("/biblioteca/view/relatorio/AnchorPaneClientesAtrasam.fxml"));
        AnchorPaneRelatorio.getChildren().setAll(root);
    }
}
